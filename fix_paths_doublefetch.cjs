...
paths = paths.replace(/export const fetchAllUsersSubcollection = [\s\S]*?(?=export const getDocsWithFallback)/, 
...
paths = paths.replace(/export const getDocsWithFallback = async [\s\S]*/, 
...
console.log('Firebase Paths Updated successfully');
